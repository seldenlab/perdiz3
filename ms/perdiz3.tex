...
from Caddo burials differ across the same geography, extending the
pattern of shape differences to a third category of Caddo material
culture. Perdiz arrow points collected from the geographies of the
northern and southern Caddo behavioral regions were employed to test the
hypothesis that morphological attributes differ, and are predictable,
between the two communities. Results indicate a significant
between-community difference in morphology. Using the same traditional
...
findings bolster recent research that posited two behavioral regions in
the ancestral Caddo area defined on the basis of discernible
...
domonstrates that Perdiz arrow point morphology differs significantly by
behavioral region (permutations = 10,000; Rsq = 0.29485;
Pr(\textgreater F) = 1e-04)
(\href{https://seldenlab.github.io/perdiz3/}{supplementary materials}).
...
artifacts recovered from Caddo internments, are not Caddo.
...
resharpening approaches employed by Caddo knappers \cite{RN9364,RN8486}.
...
communities of identity rather than communities of practice, due to the
...
criticisms, and to Julien Claude, Emma Sherratt, Kersten Bergstrom,
Lauren Butaric, Dean C. Adams, and Michael L. Collyer for their
