...
```{r fig7, out.width = "100%", dpi = 300, echo=FALSE, warning=FALSE, fig.cap="Mean shapes and comparisons of morphological differences in Gahagan biface shape by site at; a, Mounds Plantation (north, gray) and Gahagan Mound (south, black); b, Mounds Plantation (north, gray) and George C. Davis (south, black); c, Gahagan Mound (south, gray) and George C. Davis (south, black) (DOI 10.17605/OSF.IO/JKXE3)."}
