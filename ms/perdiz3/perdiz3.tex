...
Caddo network expands on those efforts, augmenting the previously
defined phases and periods, and emphasizing the dynamic and manifold
relational connections that reinforce and transcend the
...
where northern and southern communities were parsed into constituent
...
\cite{RN9515,RN9516,RN9514,RN9513}. For this effort, all linear data
...
variation and overlap of product morphology both in and between
...
specific technological or aesthetically acceptable morphological traits.
