...
distinct \emph{behavioral regions} \cite{RN8031} (Figure 1). The network
...
arrow point morphology among four of the five variables (maximum length,
...
recovered from either side of the \emph{shape boundary} (Figure 6).
...
regions} (Figure 6d) are predictable
(\href{https://seldenlab.github.io/perdiz3/}{supplementary materials}),
...
was found to occur in basal morphology (see Figure 6). Allometry was
also found to be significant, demonstrating that Perdiz arrow point
shape differs with size. Those arrow points used in this study are
