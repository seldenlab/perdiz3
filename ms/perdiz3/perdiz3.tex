...
Python and modeled using the \texttt{sklearn} package
(\href{https://seldenlab.github.io/perdiz3/}{supplementary materials}).
...
\begin{figure}
\includegraphics[width=1\linewidth]{ms-figs/figure7} \caption{Mean shapes and comparisons of morphological differences in Gahagan biface shape by site at; a, Mounds Plantation (north, gray) and Gahagan Mound (south, black); b, Mounds Plantation (north, gray) and George C. Davis (south, black); c, Gahagan Mound (south, gray) and George C. Davis (south, black) (DOI 10.17605/OSF.IO/JKXE3).}\label{fig:fig7}
\end{figure}
