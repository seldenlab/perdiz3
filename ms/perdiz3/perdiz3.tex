...
This study enlisted a combined analytical approach that incorporated
social network analysis, linear metrics, machine learning, and geometric
morphometrics that expanded the support for two discrete Caddo
behavioral regions from three categories of Caddo material culture.
While evidence from one category---Caddo bottles---supports discussions
of production, the other two---bifaces---more readily articulate with
production activities outside of the ancestral Caddo area. Further work
is warranted to expand the scope of this research program to include
analyses of differential production within the two \emph{behavioral
regions} outlined in this study using a greater diversity of diagnostic
artifact types.
