...
significant differences in Perdiz arrow point shape and size, coupled
...
behavioral regions in the ancestral Caddo area defined on the basis of
discernible morphological differences across three categories of Caddo
material culture.
\\
\keywords{
...
distinct behavioral regions \cite{RN8031} (Figure \ref{fig:fig1}). The
network analysis was limited to Historic Caddo types; however, Formative
Early Caddo (CE 800 -- 1200) Gahagan bifaces and Caddo bottle types have
been found to express significant morphological variability following
the same geographic extent \cite{RN8074,RN7927,RN8370,RN8312}, extending
the prehistoric longevity for the behavioral regions based on local
...
variables (Figure \ref{fig:fig2}a-e), and the PCA (Figure
\ref{fig:fig2}f) illustrates over 92 percent of the variation in the
sample among PC1 (84.65 percent) and PC2 (11.71 percent). ANOVAs
demonstrate significant differences in Perdiz arrow point morphology by
behavioral region among four of the five variables (maximum length,
...
\ref{fig:fig4}). The shape changes described by each principal axis are
...
landmarks against between-module covariation was significant (Figure
\ref{fig:fig5} and
\href{https://seldenlab.github.io/perdiz3/}{supplementary materials})
...
also significant (Figure \ref{fig:fig5} and
\href{https://seldenlab.github.io/perdiz3/}{supplementary materials}),
...
found to occur in basal morphology (see Figure \ref{fig:fig6}d).
Allometry was also found to be significant, demonstrating that Perdiz
arrow point shape differs with size. Those arrow points used in this
study are considered to represent design intent, and are not thought to
