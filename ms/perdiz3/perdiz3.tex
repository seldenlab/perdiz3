...
morphometrics, which expanded support for two discrete Caddo behavioral
regions to include a third category of Caddo material culture. While
evidence from one category---Caddo bottles---supports discussions of
production, the other two---bifaces---more readily articulate with
