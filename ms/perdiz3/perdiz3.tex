...
Perdiz arrow points have long been considered the epitome of the Late
Prehistoric Toyah lithic assemblage in Texas, symbolizing the
culmination of the Late Prehistoric transition to the Protohistoric
\cite{RN9718}. This arrow point style is part of the Toyah lithic
assemblage, which also includes convex end scrapers or unifaces, blades,
and well-made thin bifacial knives. In aggregate, this technological
assemblage is typically attributed to groups of highly mobile bison
hunters, and has been documented across the full extent of Texas. Even
so, our present understanding of the Toyah tool kit indicates that it
was successfully implemented in a broad-spectrum of hunting and foraging
lifeways that included not only bison, but deer and many other animal
prey species \cite{RN9718}.
...
suite of artifacts that were adopted by multiple distinct groups across
Texas as they participated in bison hunting \cite{RN9008,RN9723,RN9724}.
The primary agency of either interpretation is environmental
\cite{RN9718}; either people followed the bison from elsewhere or the
influx of bison spurred adoption of the technology among the numerous
distinct groups in Texas.
