...
Toyah lithic assemblage in Texas, and are representative of the Late
Prehistoric transition to the Protohistoric \cite{RN9718}. They are part
of the Toyah lithic assemblage, which also includes convex end scrapers
or unifaces, blades, and well-made thin bifacial knives. This
technological assemblage is typically attributed to groups of highly
mobile bison hunters, has been documented across the full extent of
Texas, and is considered to encompass a greater range of variation in
shape and size than most arrow point types in Texas
\cite{RN7795,RN3149}. Our present understanding of the Toyah tool kit
indicates that it was successfully implemented in a broad-spectrum of
hunting and foraging lifeways that included not only bison, but deer and
many other animal prey species \cite{RN9718}.
...
as a potential contributor to discussions of Late Prehistoric social and
cultural identity. Initially identified by J. Charles Kelley on the
basis of technological and morphological differences, the Toyah focus
occurs between the Protohistoric and the preceding Late Prehistoric
assemblages that have been identified as Austin \cite{RN9719,RN9720}. As
noted by Arnn:
...
Research by Arnn \cite{RN9716,RN5784,RN9717,RN9718} emphasized aspects
...
\cite{RN8999,RN9361,RN9000,RN9364}. Lithic tool stone in the ancestral
Caddo area of northeast Texas is relatively sparse, consists primarily
of chert, quartzite, and silicified wood characteristic of the local
geological formations, which may contribute to local variation in shape
and size \cite{RN9364,RN439}. It has been demonstrated elsewhere that
the morphological attributes of Perdiz arrow points from northeast Texas
...
A \emph{support vector machine} (SVM) is a supervised machine learning
model that is regularly used to classify archaeological materials
\cite{RN9515,RN9516,RN9514,RN9513}. SVMs are useful for comparing and
classifying data from digital repositories, comparative collections, as
well as open access reports and/or data. For this effort, linear data
were imported and modeled using the \texttt{scikit-learn} package in
Python \cite{scikit-learn,sklearn_api}
(\href{https://seldenlab.github.io/perdiz3/}{supplementary materials}).
...
the \texttt{geomorph} package v4.0.0 \cite{RN8565,RN9565} (Fig.3).
...
was found to occur in basal morphology (Fig. 5). Allometry was also
...
specialization can result in increased morphlogical diversity, depending
on the organization of production \cite{RN6451}. Correlations between
specialization and standardization have often, but not always, been
supported by ethnographic and experimental data
...
constituent production units that are bounded by geography and time.
