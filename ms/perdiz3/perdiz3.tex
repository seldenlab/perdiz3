...
\cite{RN8074,RN7927,RN8370,RN8312,RN8322,RN8158}. In other words, for
material culture offerings included in burial contexts, the Caddo were
\emph{selecting} for significant morphological differences in bottles
and bifaces recovered from either side of the \emph{shape boundary}
(Fig. 6). Results clearly illustrate that those morphological
differences among Perdiz arrow points found in the northern and southern
\emph{behavioral regions} are predictable
(\href{https://seldenlab.github.io/perdiz3/}{supplementary materials}),
...
\begin{figure}
\includegraphics[width=1\linewidth]{ms-figs/figure6} \caption{Mean shapes and comparisons for a, Formative/Early Caddo bottles; b, Late/Historic Caddo bottles; c, Gahagan bifaces; and d, Perdiz arrow points from the northern and southern behavioral regions.}\label{fig:fig6}
\end{figure}
